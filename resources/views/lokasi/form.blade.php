                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group row">
                            <label for="nama" class="col-md-2 col-md-offset-1 control-label">Lokasi</label>
                            <div class="col-md 6">
                                <input type="text" name="nama" id="nama" class="form-control" required
                                    oninvalid="this.setCustomValidity('Nama lokasi harus diisi')"
                                    oninput="this.setCustomValidity('')" value="RPA/" autofocus>
